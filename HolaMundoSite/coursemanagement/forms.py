...
class LessonForm(forms.Form):
	...
	tab1desc = forms.CharField(widget=CKEditorWidget())
	tab2desc = forms.CharField(widget=CKEditorWidget())
	tab3desc = forms.CharField(widget=CKEditorWidget())
	tab4desc = forms.CharField(widget=CKEditorWidget())
	tab5desc = forms.CharField(widget=CKEditorWidget())
	tab6desc = forms.CharField(widget=CKEditorWidget())
